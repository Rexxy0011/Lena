...
const CourseDetails = () => {
  ...
  return courseData ? (
    <>
      <div className="flex md:flex-row flex-col-reverse gap-10 relative items-start justify-between md:px-36 px-8 md:pt-[120px] pt-20 text-left">
        ...
        <div className="max-w-course-card z-10 shadow-custom-card rounded-t md:rounded-none overflow-hidden bg-white min-w-[300px] sm:min-w-[420px]">
          ...
          <div className="p-5">
            ...
            <div className="pt-6">
              ...
              <ul className="ml-4 pt-2 text-m md:text-default list-disc text-gray-500">
                <li>Step-by-step lessons</li>
                <li>Hands-on projects</li>
                <li>Real-world examples</li>
                <li>Quizzes and practice tasks</li>
